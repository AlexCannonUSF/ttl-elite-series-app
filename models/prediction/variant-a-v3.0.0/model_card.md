...
| Metric | Value | Pass |
| --- | --- | --- |
| ECE (15-bin, equal-mass) | `0.0171` | `True` |
| Max bin deviation | `0.0641` | `False` |
| Brier score | `0.2298` | — |
| Brier skill score vs. market | `0.1169` | `True` |
