...
@Entity
@Table(name = "paper_trade_session_shadow", indexes = {
        @Index(name = "idx_paper_session_shadow_source_session", columnList = "source_session_id", unique = true),
        @Index(name = "idx_paper_session_shadow_status", columnList = "status"),
        @Index(name = "idx_paper_session_shadow_updated", columnList = "updated_at"),
        @Index(name = "idx_paper_session_shadow_mirrored", columnList = "mirrored_at")
})
public class PaperTradeSessionShadow {
