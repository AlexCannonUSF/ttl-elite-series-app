...
@Entity
@Table(name = "paper_trade_bet_shadow", indexes = {
        @Index(name = "idx_paper_bet_shadow_source_bet", columnList = "source_bet_id", unique = true),
        @Index(name = "idx_paper_bet_shadow_session_status", columnList = "session_id, status"),
        @Index(name = "idx_paper_bet_shadow_session_placed", columnList = "session_id, placed_at"),
        @Index(name = "idx_paper_bet_shadow_session_settled", columnList = "session_id, settled_at"),
        @Index(name = "idx_paper_bet_shadow_matchup", columnList = "player1_id, player2_id"),
        @Index(name = "idx_paper_bet_shadow_dedupe", columnList = "session_id, dedupe_key"),
        @Index(name = "idx_paper_bet_shadow_mirrored", columnList = "mirrored_at")
})
public class PaperTradeBetShadow {
    ...
    @Column(name = "source_bet_id", nullable = false, unique = true)
    private Long sourceBetId;
    ...
    private void touchMirrorMetadata() {
        if (mirroredAt == null) {
            mirroredAt = LocalDateTime.now();
        } else {
            mirroredAt = LocalDateTime.now();
        }
    ...
    public Long getSourceBetId() {
        return sourceBetId;
    }

    public void setSourceBetId(Long sourceBetId) {
        this.sourceBetId = sourceBetId;
    }
    ...
    public LocalDateTime getMirroredAt() {
        return mirroredAt;
    }

    public void setMirroredAt(LocalDateTime mirroredAt) {
