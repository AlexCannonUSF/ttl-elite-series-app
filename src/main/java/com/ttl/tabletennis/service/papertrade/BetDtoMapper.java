...
public final class BetDtoMapper {
    ...
    public static PaperTradeBetDto toDto(PaperTradeBet bet, String trackingState) {
        return new PaperTradeBetDto(
                ...
                bet.getSettlementEvidenceFingerprint(),
                bet.getSettlementEvidenceSourceCount(),
                bet.getSettlementCoverageState(),
                bet.getSettlementAmbiguityScore(),
                bet.getSettlementObservedAt(),
                ...
                bet.getScoreEvidenceInferredWinnerId(),
                bet.getScoreEvidenceLatestScore(),
                bet.getScoreEvidenceLatestPhase(),
                bet.isScoreEvidenceContradictory(),
                bet.getClosingDecimalOdds(),
                bet.getClosingObservedAt(),
                bet.getClosingSource(),
                bet.getClosingMarketState(),
